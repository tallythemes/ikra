...
function mr_image_resize($url, $width=null, $height=null, $crop=true, $align='c', $retina=false) {
  ...
  if (!file_exists($dest_file_name)) {
	...
	if($get_attachment == NULL){
		...
		if(file_exists(get_stylesheet_directory().'/images/demo/'.$the_image_name)){ $get_attachment = get_stylesheet_directory_uri().'/images/demo/'.$the_image_name; }
		elseif(file_exists(get_template_directory().'/images/demo/'.$the_image_name)){ $get_attachment = get_template_directory_uri().'/images/demo/'.$the_image_name; }
	}
